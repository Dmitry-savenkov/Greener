                ...
                <View style={{ backgroundColor: '#ffffff', margin: 30, padding: 35, borderRadius: 10, marginTop: 50 }}>
                    ...
                    <ScrollView>
                        <Text>
                            ...
                            <View>
                                <Text style={{ marginBottom: 10 }}>
                                    1.2. Information - any information posted (posted) by the User or the Administration
                                    in the Mobile Application, including the User's personal data, information about
                                    third parties posted by the User, links to other sites, any text messages, photos
                            ...
                            <View>
                                <Text>
                                    1.4. Mobile application - software (mobile application "ONEIMPACT BELARUS") designed
                                    to work on smartphones, tablets and other mobile devices, developed for a specific
